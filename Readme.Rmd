...
La versión final del trabajo puede visualizarse en: <https://Valldecabres.github.io/trabajo_BigData/>. 
...
Este trabajo se trata de un análisis de los datos relacionos con el tenis su próposito es aprender un poco más sobre este deporte a la vez que mejorar en el manejo del lenguaje de programación R.
